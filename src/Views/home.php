    ...
    <div class="row">
        <div class="col-lg-4 text-center mx-auto mt-5">
            <div class="card" style="width: 18rem;">
                <img src="https://cdn.radiofrance.fr/s3/cruiser-production/2019/04/12984aca-2ec8-436e-8a88-34f27ae2f84f/838_gettyimages-185096889.jpg" class="card-img-top" alt="...">
                <div class="card-body">
